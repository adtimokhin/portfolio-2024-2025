...
let areOn = []; // boolean array that shows whether the rectangle is toggled to be black
let tunedFlickers = []; // This array contains flicker delay multiplied by the animation duration

let paused = true; // Flag to show if animation is playing
